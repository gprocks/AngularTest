...
//test
  getCurrentRaceSchedule(): Observable<RaceScheduleCurrent[]> {
    return this.http
      .get<String>("https://cors-anywhere.herokuapp.com/https://files-f1.motorsportcalendars.com/f1-calendar_p1_p2_p3_qualifying_sprint_gp.ics", { responseType: "text" as "json" })
      .pipe(
